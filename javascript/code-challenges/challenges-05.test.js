...
const toLastNames = people => {
   let newArr = people.map(e => e.firstName + ' ' + e.lastName);
    return newArr;
};
/* ------------------------------------------------------------------------------------------------
CHALLENGE 2
...
const addValues = (arr) => {
  let newAdd = arr.reduce((sum, sumValue) => {
    return sum + sumValue;
  },0)
return newAdd
};
...
const addPurchases = (arr) => {
  var newPurch = arr.reduce((accumaltor, currentValue) =>{
    return accumaltor + currentValue.purchasePrice
  },0);
return newPurch
};
