...
const containsW = (str) => {
 // create a regular expression pattern that matches the letter "w" in lowercase
 const pattern = /w/;
 // use the test method of the regular expression pattern to check whether the string contains the letter "w
...
const isNum = (input) => {
 // Create a regular expression pattern that matches any digit between 0 and 9.
 const pattern = /\d/;
// Use the test method of the regular expression pattern to check whether the input contains a digit. The test method returns true if a match is found and false otherwise. Return the result of the test method.
...
const containsWorld = (input) => {
 // Create a regular expression pattern that matches the word "world" in lowercase.
 const pattern = /\bworld\b/;
// Use the test method of the regular expression pattern to check whether the input contains the word "world" in lowercase. The test method returns true if a match is found and false otherwise. Return the result of the test method.
return pattern.test(input);
...
//  Create a regular expression pattern that matches words that begin with a capital letter. The pattern matches a word boundary \b, followed by an uppercase letter [A-Z], followed by zero or more lowercase letters [a-z]*, followed by another word boundary \b. The g flag is used to match all occurrences of the pattern in the input string. 
const pattern = /\b[A-Z][a-z]*\b/g;
// Use the match method of the input string to find all the matches of the regular expression pattern in the input string. The match method returns an array of all the matches. Return this array.
